...
def segment_bacterial_constitutive(constitutive_image, threshold=None, props=None):
    if threshold is None:
        threshold = threshold_otsu(constitutive_image)
    ...
    opened_mask = skimage.morphology.binary_opening(constitutive_image > threshold, skimage.morphology.disk(2))    
