...
def InitializeValuesDatabaseV110(
    ...
    # ---- FOVs TABLE ----
        ...
        CREATE TABLE IF NOT EXISTS FOVs (
            ...
            PRIMARY KEY (plate_name, well_row, well_column, well_site),
    ...
    # ---- CELLS TABLE ----
        ...
        CREATE TABLE IF NOT EXISTS cells (
            ...
            PRIMARY KEY (plate_name, well_row, well_column, well_site, cell_id),
            
            FOREIGN KEY (plate_name, well_row, well_column, well_site)
                REFERENCES FOVs(plate_name, well_row, well_column, well_site),
    ...
    # ---- CONSTITUTIVE TABLE----
        ...
        CREATE TABLE IF NOT EXISTS constitutive (
            ...
            PRIMARY KEY (plate_name, well_row, well_column, well_site, constitutive_id),
    ...
    # ---- REPORTER TABLE----
        ...
        CREATE TABLE IF NOT EXISTS reporter (
            ...
            PRIMARY KEY (plate_name, well_row, well_column, well_site, reporter_id),
    ...
    # ---- CONSTITUTIVE OVERLAPS TABLE----
        ...
        CREATE TABLE IF NOT EXISTS cell_bac_overlaps (
            ...
            PRIMARY KEY (plate_name, well_row, well_column, well_site, const_overlap_id),
            
            FOREIGN KEY (plate_name, well_row, well_column, well_site, cell_id)
                REFERENCES cells (plate_name, well_row, well_column, well_site, cell_id),
            
            FOREIGN KEY (plate_name, well_row, well_column, well_site, constitutive_id)
                REFERENCES constitutive (plate_name, well_row, well_column, well_site, constitutive_id),
        ...
        CREATE TABLE IF NOT EXISTS reporter_overlaps (
            ...
            PRIMARY KEY (plate_name, well_row, well_column, well_site, rep_overlap_id),
            
            FOREIGN KEY (plate_name, well_row, well_column, well_site, reporter_id)
                REFERENCES reporter (plate_name, well_row, well_column, well_site, reporter_id),
            
            FOREIGN KEY (plate_name, well_row, well_column, well_site, const_overlap_id)
                REFERENCES cell_bac_overlaps (plate_name, well_row, well_column, well_site, const_overlap_id),
